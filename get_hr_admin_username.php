        ...
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px; background-color: #800000;">
            <div class="card-body p-4 p-md-5">
              ...
              <!--Center Text-->
              <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 text-center" style="color: #FFFFFF;"><b>Get HR Admin Username</b></h3>

              <!--Form Tag-->
              <form action="get_hr_admin_username_logic.php" method="post">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 mb-4">
                    <div class="form-outline">
                      ...
                      <label class="form-label" for="email" style="color: #FFFFFF;">Enter your HR Admin Email Address</label>
                    </div>
                  </div>
                </div>
