...
while ($result = mysqli_fetch_array($run)) {
  ...
  //INSERT QUERY FOR CHECKED_IN
  $query = "INSERT INTO checked_in (booking_id, username, fname, lname, no_of_beds, from_date, to_date, hr_name, hr_admin_name) 
  VALUES($id, '$username', '$fname', '$lname', $no_of_beds, '$from_date', '$to_date', '$hr_name', '$hr_admin_name')";

  //INSERT QUERY FOR CHECKED_IN_HISTORY
  $checkINhistory_query = "INSERT INTO checked_in_history (booking_id, username, fname, lname, no_of_beds, from_date, to_date, hr_name, hr_admin_name) 
  VALUES($id, '$username', '$fname', '$lname', $no_of_beds, '$from_date', '$to_date', '$hr_name', '$hr_admin_name')";
  $checkINhistory_run = mysqli_query($conn, $checkINhistory_query);

  if ($conn->query($query) === TRUE) {

    //DELETING FROM CONFIRMATION
    $query02 = "DELETE FROM confirmations WHERE booking_id = '$id' ";
    ...
    $message = "Hope you will have a good stay.";
