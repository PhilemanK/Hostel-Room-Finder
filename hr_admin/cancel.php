...
while ($result = mysqli_fetch_array($run)) {
  ...
  $query009 = "INSERT INTO cancellations (booking_id, username, fname, lname, no_of_beds, from_date, to_date, hr_name, hr_admin_name) 
  ...
  if ($conn->query($query) === TRUE) {
    ...
    $message = "Sorry for the inconvenience, your booking has been cancelled.";
