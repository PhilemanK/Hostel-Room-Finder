...
<body>
  <section class="background">
    ...
    ?>
        ...
        <div class="row justify-content-center align-items-center h-auto">
          <div class="col-xxl-11">
            <div class="container p-5 " style="background-color: #800000; border-radius: 15px;">
              ...
              <!--OPTIONS-->
              <!--CHECK-IN BUTTON-->
              <button type="button" style="background-color: #FFFFFF; color:#800000; border-color:#800000;" class="btn m-1" data-bs-toggle="modal" data-bs-target="#check_in">
                <b>Check-In User</b>
              </button>
            </div>
          <?php
      ...
      <!-- CHECK_IN MODAL -->
      <div class="modal fade" id="check_in" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="staticBackdropLabel" style="background-color: #FFFFFF; color:#800000;"><b>Check-In User</b></h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" style="background-color: #FFFFFF; color:#800000;">
              Do you want to <b>check-in</b> this user named <b><?php echo $result['fname'];
                                                                echo " ";
                                                                echo $result['lname']; ?> </b> ?
            </div>
            <div class="modal-footer">
              ...
              <form action="" method="POST">
                <a class="btn btn-secondary" style="background-color:#800000;" role="button" <?php echo " href=check_in.php?booking_id=" . $result['booking_id'] . ">Check-In</a>"; ?> </form>
            </div>
          </div>
        </div>
      </div>
