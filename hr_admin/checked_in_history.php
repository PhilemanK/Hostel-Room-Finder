...
<body>
  <section class="background">
    ...
    <!--Bookings-->
    <h2 class=" text-center" style=" color: #800000;"><b>Checked-In History</b></h2>
    <!--PROGRAM TO DISPLAY CURRENT BOOKINGS-->
    <?php
    $conn = mysqli_connect("localhost", "root", "", "hr");
    $db = mysqli_select_db($conn, "hr");
    $query = "SELECT * FROM checked_in_history WHERE hr_admin_name = '$username' ";
          ...
          <div class="col g-4">
            <div class="p-3 border " style="background-color: #c0c0c0; border-radius: 15px; color: #800000;">
              <h5> <b><?php echo "<td>" . $row['fname'] . "</td>"; ?></b><br>
                ...
                <a class="btn btn-secondary" style="background-color:#800000;" role="button" <?php echo " href=checked_in_description.php?booking_id=" . $row['booking_id'] . ">Details</a>"; ?> </h5>
            </div>
          </div>
        </div>
      </div>
