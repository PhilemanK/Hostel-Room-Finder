...
<body>
  <section class="background">
    ...
    $id = $_REQUEST['id'];
    $_SESSION['id'] = $id;
    $query = "SELECT * FROM bookings_history WHERE booking_id = '$id'     ";
    ...
    ?>
        ...
        <div class="row justify-content-center align-items-center h-auto">
          <div class="col-xxl-11">
            <div class="container p-5 " style="background-color: #800000; border-radius: 15px;">
              ...
              <!--OPTIONS-->
              <!--CONFIRM BUTTON-->
              <button type="button" style="background-color: #FFFFFF; color:#800000; border-color:#800000;" class="btn m-1" data-bs-toggle="modal" data-bs-target="#confirm">
                <b>Confirm Booking</b>
              </button>
              <!--CANCEL BUTTON-->
              <button type="button" style="background-color: #FFFFFF; color:#800000; border-color:#800000;" class="btn m-1" data-bs-toggle="modal" data-bs-target="#cancel">
                <b>Cancel Booking</b>
              </button>
            </div>
          <?php
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="staticBackdropLabel" style="background-color: #FFFFFF; color:#800000;"><b>Confirm Booking</b></h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" style="background-color: #FFFFFF; color:#800000;">
              Do you want to <b>confirm</b> the booking of <b><?php echo $result['fname'];
                                                              echo " ";
                                                              echo $result['lname']; ?> </b> ?
            </div>
            <div class="modal-footer">
              ...
              <form action="" method="POST">
                <a class="btn btn-secondary" style="background-color:#800000;" role="button" <?php echo " href=confirm.php?booking_id=" . $result['booking_id'] . ">Confirm</a>"; ?> </form>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="cancel" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="staticBackdropLabel" style="background-color: #FFFFFF; color:#800000;"><b>Cancel Booking</b></h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" style="background-color: #FFFFFF; color:#800000;">
              Do you want to <b>cancel</b> the booking of <b><?php echo $result['fname'];
                                                              echo " ";
                                                              echo $result['lname']; ?> </b> ?
            </div>
            <div class="modal-footer">
              ...
              <!--CANCEL FORM-->
              <form action="" method="POST">
                <a class="btn btn-secondary" style="background-color:#800000;" role="button" <?php echo " href=cancel.php?booking_id=" . $result['booking_id'] . ">Cancel</a>"; ?> </form>
            </div>
          </div>
        </div>
      </div>
