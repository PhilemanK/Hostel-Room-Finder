...
if (isset($_POST['submit'])) {
  ...
  $fileextstored01 = array('png', 'jpg', 'jpeg');
  ...
  if (in_array($filecheck01, $fileextstored01)) {
    ...
    $fileextstored02 = array('png', 'jpg', 'jpeg');
    ...
    if (in_array($filecheck02, $fileextstored02)) {
      ...
      $fileextstored03 = array('png', 'jpg', 'jpeg');
      ...
      if (in_array($filecheck03, $fileextstored03)) {
        ...
        $fileextstored04 = array('png', 'jpg', 'jpeg');
        ...
        if (in_array($filecheck04, $fileextstored04)) {
          ...
          $fileextstored05 = array('png', 'jpg', 'jpeg');
          ...
          if (in_array($filecheck05, $fileextstored05)) {
            ...
            $fileextstored06 = array('png', 'jpg', 'jpeg');
    ...
    if ($rows === 0) {
      ...
      $query = "INSERT INTO hr_table(username, hr_admin_name, hr_name, hr_type, hr_address, hr_city, hr_number, hr_email, hr_laundry, hr_food_type, hr_bg, hr_total_beds, hr_beds_avail, hr_beds_occup, hr_price_per_year, hr_price_per_month, hr_price_per_day, hr_build_img, hr_reception_img, hr_room_img01, hr_room_img02, hr_restroom01_img, hr_restroom02_img) 
