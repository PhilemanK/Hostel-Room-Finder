        ...
        <div class="row justify-content-center align-items-center h-auto">
          <div class="col-xxl-11">
            <div class="container p-5 " style="background-color: #800000; border-radius: 15px;">
              ...
              <!--OPTIONS-->
              <!--CHECK-IN BUTTON-->
              <button class="btn " type="button" style="background-color: #FFFFFF;color: #800000; border-style: solid; border-color:#045E5E; color: #800000" aria-current="page" data-bs-toggle="offcanvas" data-bs-target="#feedback" aria-controls="offcanvasTop">Feedback</button>
            </div>
          <?php
                }
          ?>
