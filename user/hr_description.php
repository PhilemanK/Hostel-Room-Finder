            ...
            <div class="card-body p-4 p-md-5">
              ...
              ?>
                ...
                <div class="container">
                  <div class="row g-2">
                    <div class="col-6">
                      <div class="p-3 border" style="border-radius: 15px; background-color:#FFFFFF; color:#800000"><b>Hostel / Room</b><br><?php echo $result['hr_type']; ?></div>
                    </div>
                    <div class="col-6">
                  ...
                  <button class="btn m-1" type="button" aria-current="page" data-bs-toggle="offcanvas" data-bs-target="#book" aria-controls="offcanvasTop" style="background-color: #FFFFFF; color: #800000; border-style: solid; border-color:#045E5E;"><b>Book</b></button>
                </div>
            </div>
          </div>
        </div>
            ...
            ?>
                <div class="container">
                  <div class="row g-2 m-3">
                    <div class="col-75">
                      <div class="p-3 border" style="border-radius: 15px; background-color:#AAF0D1; color:#800000">
