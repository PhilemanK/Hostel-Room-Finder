  ...
  <div class="container py-5 h-auto">
    <div class="row justify-content-center align-items-center h-auto">
      ...
      <div class="col-xxl-6">
        ...
        $conn = mysqli_connect("localhost", "root", "", "hr");
        $db = mysqli_select_db($conn, "hr");
        $hostels_query = "SELECT * FROM hr_table WHERE hr_type = 'Hostel' LIMIT 5 ";
        ...
        ?>
          ...
          <div class="col-xxl-6">
            ...
            $conn = mysqli_connect("localhost", "root", "", "hr");
            $db = mysqli_select_db($conn, "hr");
            $rooms_query = "SELECT * FROM hr_table WHERE hr_type = 'Room' LIMIT 5 ";
              ...
              <div class="container px-4">
                <div class="row gx-5">
                  <div class="col">
                    ...
                    <div class="p-3 border " style="background-color: #c0c0c0; color:#800000; border-radius: 15px;">
                      <h5> <b><?php echo "<td>" . $rooms_row['hr_name'] . "</td>"; ?></b><br>
                        City : <?php echo "<td>" . $rooms_row['hr_city'] . "</td>"; ?><br>
                        Boys / Girls : <?php echo "<td>" . $rooms_row['hr_bg'] . "</td>"; ?><br>
                        Beds Available : <?php echo "<td>" . $rooms_row['hr_beds_avail'] . "</td>"; ?><br>
                        <a class=" btn btn-secondary" style="background-color: #800000; color:#FFFFFF; border:#800000 1px solid;" role="button" <?php echo " href=hr_description.php?username=" . $rooms_row['username'] . ">Details</a>"; ?> </div>
                    </div>
                  </div>
                </div>
              <?php
