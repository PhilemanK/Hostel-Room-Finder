...
<body>
  <section class="background">
    ...
    <div class="jumbotron text-center">
      <h2 style="color:#800000;"><b>User Data</b></h2>
    </div>
      ...
      <table class="table  table-hover">
        <thead>
          <tr>
            ...
            <th scope="col">Guardian's Number 01</th>
            <th scope="col">Guardian's Number 02</th>
        ...
        <tbody>
          <tr>
            ...
            while ($result = mysqli_fetch_array($run)) {
              ...
              echo "<td>" . $result['g_num01'] . "</td>";
              echo "<td>" . $result['g_num02'] . "</td>";
              echo "<td> <a href=users_desc.php?id=" . $result['id'] . "> Edit </a> </td>";
              echo " </td>";
            }
            ?>
        </tbody>
