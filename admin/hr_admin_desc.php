        ...
        <div class="col-xxl-11">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px; background-color:#800000;">
            <div class="card-body p-4 p-md-5">
              ...
              $id = $_REQUEST['id'];
              $query = "SELECT * FROM hr_admin WHERE id = '$id' ";
                  ...
                  <div class="row g-2">
                    ...
                    <div class="col-12">
                      ...
                      if (isset($_POST['username_submit'])) {
                        ...
                        $username_query = "UPDATE hr_admin SET username = '$username' WHERE id = '$id'";
                    ...
                    <div class="col-12">
                      ...
                      if (isset($_POST['fname_submit'])) {
                        $fname = $_POST['fname'];
                        $fname_query = "UPDATE hr_admin SET fname = '$fname' WHERE id = '$id'";
                    ...
                    <div class="col-12">
                      ...
                      if (isset($_POST['lname_submit'])) {
                        $lname = $_POST['lname'];
                        $lname_query = "UPDATE hr_admin SET lname = '$lname' WHERE id = '$id'";
                    ...
                    <div class="col-12">
                      ...
                      if (isset($_POST['number_submit'])) {
                        $number = $_POST['number'];
                        $number_query = "UPDATE hr_admin SET number = '$number' WHERE id = '$id'";
                    ...
                    <div class="col-12">
                      ...
                      if (isset($_POST['email_submit'])) {
                        $email = $_POST['email'];
                        $email_query = "UPDATE hr_admin SET email = '$email' WHERE id = '$id'";
                    ...
                    <div class="col-12">
                      ...
                      if (isset($_POST['city_submit'])) {
                        $city = $_POST['city'];
                        $city_query = "UPDATE hr_admin SET city = '$city' WHERE id = '$id'";
                    ...
                    <div class="col-12">
                      ...
                      if (isset($_POST['gender_submit'])) {
                        $gender = $_POST['gender'];
                        $gender_query = "UPDATE hr_admin SET gender = '$gender' WHERE id = '$id'";
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body" style="color:#800000">
                              Are you sure, you want to delete this HR Admin named <?php echo $result['fname']; ?> ?
                            </div>
                    ...
                    if (isset($_POST['delete'])) {
                      ...
                      $delete_query = "DELETE FROM hr_admin WHERE id = '$id'";
                      //$delete_run = mysqli_query($conn, $delete_query);
                      if ($conn->query($delete_query) === TRUE) {
                        header("Location: admin_hr_admin.php ");
                      }
                    } ?>
                  </div>
                </div>
